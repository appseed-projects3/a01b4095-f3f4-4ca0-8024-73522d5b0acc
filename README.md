...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-03 10:08`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a01b4095-f3f4-4ca0-8024-73522d5b0acc.git
$ cd a01b4095-f3f4-4ca0-8024-73522d5b0acc
```
